...
happyExpList = Happy_Data_Array.listArray (0,61) ([17408,52,2048,0,0,0,0,0,128,53520,34816,104,0,0,0,0,0,0,128,0,0,2,32,8192,0,4,4352,32781,1672,0,1,400,0,0,0,0,0,0,0,8192,0,16,2048,0,0,0,0,0,6690,4352,32781,1672,8192,3,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser_hsk","Exp","BracketExp","FunArgs","SingleAssignment","Assignments","SingleCase","Cases","'let'","'='","';'","'in'","'case'","'of'","'->'","'otherwise'","'('","')'","iden","num_const","%eof"]
        bit_start = st * 23
        bit_end = (st + 1) * 23
...
action_5 (8) = happyGoto action_16
...
action_10 (6) = happyGoto action_24
...
action_25 (13) = happyShift action_36
...
happyReduction_1 (HappyTerminal (Identificator happy_var_1))
	 =  HappyAbsSyn4
		 (Iden happy_var_1
	)
...
happyReduction_2 (HappyTerminal (NaturalConstant happy_var_1))
	 =  HappyAbsSyn4
		 (Num happy_var_1
	)
...
happyReduction_3 (HappyAbsSyn6  happy_var_2)
	(HappyTerminal (Identificator happy_var_1))
	 =  HappyAbsSyn4
		 (AppFun happy_var_1 happy_var_2
	)
...
happyReduction_11 (HappyAbsSyn4  happy_var_3)
	...
	(HappyTerminal (Identificator happy_var_1))
	 =  HappyAbsSyn7
		 (Main.Assignment happy_var_1 happy_var_3
	)
...
happyReduction_14 (HappyAbsSyn4  happy_var_3)
	...
	(HappyTerminal (Identificator happy_var_1))
	 =  HappyAbsSyn9
		 (CaseIden happy_var_1 happy_var_3
	)
...
happyReduction_15 (HappyAbsSyn4  happy_var_3)
	_
	(HappyTerminal (NaturalConstant happy_var_1))
	 =  HappyAbsSyn9
		 (CaseNum happy_var_1 happy_var_3
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	ReservedWord Let -> cont 11;
	ReservedWord ScannerHskP.Assignment -> cont 12;
	ReservedWord DotComma -> cont 13;
	ReservedWord In -> cont 14;
	ReservedWord Case -> cont 15;
	ReservedWord Of -> cont 16;
	ReservedWord RightArrow -> cont 17;
	ReservedWord Otherwise -> cont 18;
	BracketOpen -> cont 19;
	BracketClose -> cont 20;
	Identificator happy_dollar_dollar -> cont 21;
	NaturalConstant happy_dollar_dollar -> cont 22;
	_ -> happyError' ((tk:tks), [])
	}
...
parser_hsk tks = happyRunIdentity happySomeParser where
