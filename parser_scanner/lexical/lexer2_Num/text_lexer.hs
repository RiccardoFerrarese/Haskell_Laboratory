...
alex_table = listArray (0 :: Int, 368)
  [ 0
  , 10
  , 10
  , 10
...
alex_check = listArray (0 :: Int, 368)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_0 = const readAnIntegerToken
alex_action_1 = \_ s -> readAFloatToken s  
alex_action_2 = const readAFractionalToken
alex_action_3 = const readAFloatToken
